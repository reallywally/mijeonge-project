...
const meetings: Meeting[] = [
  {
    ...
    memos: [
      ...
      {
        id: 'mm2',
        text: 'PG사가 5월에 API v3를 낸다고 한다. 아직 문서는 안 나왔다.',
        promotedThreadId: null,
      },
      {
        id: 'mm3',
        text: '이도현이 다음 주 휴가라 이중화 상세는 4월 첫 주에.',
        promotedThreadId: null,
      },
    ],
  },
...
const threads: Thread[] = [
  ...
  },
  {
    id: 't5',
    projectId: 'p1',
    title: '배포 시간대를 트래픽이 낮은 새벽으로 옮길지',
    state: 'open',
    ownerId: null,
    parentThreadId: null,
  ...
  },
  {
    id: 't4',
    projectId: 'p1',
    title: '재시도가 모두 실패했을 때 구독을 자동 해지할지',
    state: 'decided',
    ownerId: 'u2',
    parentThreadId: 't2',
...
const entries: Entry[] = [
  ...
  },
  {
    ...
    detail: [
      '일반 실패 — 1분 → 10분 → 1시간, 최대 3회',
      '5xx 응답 — 최대 4회까지',
      '잔액 부족 — 재시도하지 않고 바로 알림',
    ],
    note: '이전 결정(최대 3회 즉시 재시도)을 대체했습니다.',
    ownerId: 'u1',
    createdAt: '2026-03-12',
  },
  {
    ...
    meetingId: 'mt4',
    kind: 'split',
    text: '재시도를 모두 소진한 구독의 처리는 따로 안건으로 올렸다',
    detail: [],
    note: '약관 확인까지 따로 쫓아다녀야 해서 분리했습니다.',
    ownerId: null,
    createdAt: '2026-03-12',
  },
  {
    ...
    meetingId: 'mt5',
    kind: 'refine',
    text: '1시간 시도까지 실패하면 더 재시도하지 않는다',
    detail: [],
    note: '',
    ownerId: 'u1',
  ...
  // t4 자동 해지 — 회의 밖 처리 포함
  {
    ...
    meetingId: 'mt4',
    kind: 'raise',
    text: '재시도가 모두 실패한 구독을 어떻게 할지 물음',
    detail: [],
    note: '',
    ownerId: null,
    createdAt: '2026-03-12',
  ...
  },
  {
    ...
    meetingId: null,
    kind: 'decide',
    text: '약관상 걸리는 것이 없어 자동 해지하기로 함',
    detail: [],
    note: '정책팀 확인 결과를 담당자가 그대로 반영했습니다.',
    ownerId: 'u2',
  ...
  // t1 알림 채널
  {
    ...
    meetingId: 'mt2',
    kind: 'raise',
    text: '알림이 채널마다 따로 나가서 사용자가 중복으로 받는다',
    detail: [],
    note: '',
    ownerId: null,
    createdAt: '2026-02-20',
  ...
  },
  {
    ...
    meetingId: 'mt4',
    kind: 'defer',
    text: '이번에도 결론을 내지 못했다',
    detail: [],
    note: '전사 알림 구조 문제라는 의견.',
    ownerId: null,
    createdAt: '2026-03-12',
  },
  {
  ...
  },
  {
    ...
    meetingId: 'mt3',
    kind: 'decide',
    text: '롤백 절차를 문서로 만들고 온콜 교육에 포함한다',
    detail: [],
    note: '',
    ownerId: 'u2',
    createdAt: '2026-03-08',
...
const requests: Request[] = [
  {
    ...
    projectId: 'p1',
    title: '결제 실패 데이터 정리',
    body: '3월 결제 실패 건 데이터 좀 정리해 주실 수 있을까요?\n이번 주 회의에서 재시도 정책 얘기할 때 근거로 쓰려고 합니다.',
    state: 'doing',
    requesterId: 'u4',
    assigneeId: 'u2',
    dueDate: '2026-03-26',
  ...
  },
  {
    id: 'rq2',
    projectId: 'p1',
    title: '3월 정산서 숫자 한번 봐주세요',
    body: '3월 정산서 숫자 한번 봐주세요. 환불 반영이 이상한 것 같습니다.',
    state: 'doing',
    requesterId: 'u2',
    assigneeId: 'u1',
    dueDate: '2026-03-24',
    ...
    spec: {
      points: [
        '3월 정산서의 환불 반영액이 결제 원장과 맞는지 본다.',
        '어긋나면 어느 건이 어긋났는지까지 짚어 준다.',
      ],
      confirmed: true,
      confirmedById: 'u2',
  ...
  },
  {
    id: 'rq3',
    projectId: 'p1',
    title: '알림 발송 로그 2월치도 필요합니다',
    body: '알림 발송 로그 2월치도 필요합니다.',
    state: 'doing',
    requesterId: 'u1',
    assigneeId: 'u2',
    dueDate: '2026-03-27',
    ...
    createdAt: '2026-03-19',
    spec: {
      points: ['2월 알림 발송 로그를 채널별로 뽑는다.', '중복 발송으로 보이는 건은 따로 표시한다.'],
      confirmed: true,
      confirmedById: 'u1',
  ...
  },
  {
    id: 'rq4',
    projectId: 'p1',
    title: '배포 체크리스트가 최신인지 확인',
    body: '배포 체크리스트가 지난 분기 것 같은데 한번 봐주실 분 계실까요?',
    state: 'todo',
    requesterId: 'u4',
    assigneeId: null,
    dueDate: null,
  ...
  },
  {
    id: 'rq5',
    projectId: 'p1',
    title: '온콜 담당표 이번 분기 것 맞는지',
    body: '온콜 담당표가 이번 분기 것으로 맞는지 확인 부탁드립니다.',
    state: 'todo',
    requesterId: 'u3',
    assigneeId: 'u4',
    dueDate: '2026-03-25',
  ...
  },
  {
    id: 'rq6',
    projectId: 'p1',
    title: '테스트 계정 정리해 주세요',
    body: '스테이징 테스트 계정이 너무 많이 쌓였습니다. 정리 부탁드려요.',
    state: 'todo',
    requesterId: 'u1',
    assigneeId: 'u3',
    dueDate: '2026-03-30',
    ...
    spec: {
      points: [
        '스테이징에 쌓인 테스트 계정 중 3개월 넘게 안 쓴 것을 지운다.',
        '지우기 전에 목록을 한 번 공유한다.',
      ],
      confirmed: true,
      confirmedById: 'u1',
      confirmedAt: '2026-03-21',
      fromCommentCount: 1,
    },
  },
  {
    id: 'rq7',
    projectId: 'p1',
    title: '구독 해지 사유 코드 목록 뽑아주세요',
    body: '구독 해지 사유 코드 목록 좀 뽑아주세요. 자동 해지 붙일 때 필요합니다.',
    state: 'done',
    requesterId: 'u2',
    assigneeId: 'u3',
    dueDate: '2026-03-20',
    ...
    spec: {
      points: [
        '해지 사유 코드와 뜻을 표로 정리한다.',
        '자동 해지로 붙는 코드가 어느 것인지 표시한다.',
      ],
      confirmed: true,
      confirmedById: 'u2',
      confirmedAt: '2026-03-17',
      fromCommentCount: 1,
    },
  },
  {
    id: 'rq8',
    projectId: 'p1',
    title: 'PG사 계약서 사본 어디 있는지',
    body: 'PG사 계약서 사본 어디 있는지 아시는 분?',
    state: 'done',
    requesterId: 'u1',
    assigneeId: 'u4',
    dueDate: '2026-03-18',
    ...
    spec: {
      points: [
        '토스페이먼츠 · 나이스페이 계약서 사본 위치를 알려준다.',
        '접근 권한이 없으면 권한까지 열어 준다.',
      ],
      confirmed: true,
      confirmedById: 'u1',
...
const requestComments: RequestComment[] = [
  {
    ...
    requestId: 'rq1',
    authorId: 'u2',
    text: '어떤 데이터를 말씀하시는 걸까요? 실패 로그 원본인지, 사유별로 몇 건인지 세어 놓은 것인지에 따라 작업이 완전히 달라서요.',
    createdAt: '2026-03-21T10:31',
  },
  {
    id: 'rc3',
    requestId: 'rq1',
    authorId: 'u4',
    text: '사유별로 몇 건인지가 궁금해요. 이번 주 회의에서 재시도 정책 얘기할 때 근거로 쓰려고 합니다.',
    createdAt: '2026-03-21T10:40',
  },
  {
    id: 'rc4',
    requestId: 'rq1',
    authorId: 'u2',
    text: '기간은 어떻게 잡을까요? 3월 전체면 PG사가 두 곳 섞여 있는데, 나눠서 드리는 게 나을까요?',
    createdAt: '2026-03-21T11:02',
  },
  {
    id: 'rc5',
    requestId: 'rq1',
    authorId: 'u4',
    text: '3월 1일부터 20일까지요. PG사는 나눠 주시면 좋겠습니다.',
    createdAt: '2026-03-21T11:15',
  },
  {
    id: 'rc6',
    requestId: 'rq1',
    authorId: 'u1',
    text: '실패한 뒤 재시도로 살아난 비율도 같이 보면 좋을 것 같은데요. 그게 있어야 재시도 횟수를 늘릴지 말지 얘기가 됩니다.',
    createdAt: '2026-03-21T13:47',
  },
  {
    id: 'rc7',
    requestId: 'rq1',
    authorId: 'u4',
    text: '그것도 넣어 주세요.',
    createdAt: '2026-03-21T14:02',
  },
  {
    id: 'rc8',
    requestId: 'rq1',
    authorId: 'u2',
    text: '알겠습니다. 형식은 시트로 드리면 될까요?',
    createdAt: '2026-03-21T14:20',
  },

  {
    ...
    requestId: 'rq2',
    authorId: 'u1',
    text: '어느 항목이 이상한가요? 전체를 다 대조하려면 시간이 좀 걸려서요.',
    createdAt: '2026-03-20T09:22',
  },
  {
    id: 'rc11',
    requestId: 'rq2',
    authorId: 'u2',
    text: '환불 반영액만요. 결제 원장이랑 맞는지 보시면 됩니다.',
    createdAt: '2026-03-20T09:30',
  },

  {
    ...
    authorId: 'u2',
    text: '채널별로 나눠 드릴까요?',
    createdAt: '2026-03-19T11:12',
  },
  {
    id: 'rc14',
    requestId: 'rq3',
    authorId: 'u1',
    text: '네, 채널별로요. 중복으로 나간 것 같은 건도 표시해 주시면 좋겠습니다.',
    createdAt: '2026-03-19T11:20',
  },
  {
    id: 'rc15',
    requestId: 'rq3',
    authorId: 'u2',
    text: '알겠습니다.',
    createdAt: '2026-03-19T11:25',
  },
  {
    id: 'rc16',
    requestId: 'rq3',
    authorId: 'u1',
    text: '아 그리고 1월치도 같이 볼 수 있을까요? 2월만 보면 추세를 모르겠어서요.',
    createdAt: '2026-03-23T09:05',
  },
  {
    id: 'rc17',
    requestId: 'rq3',
    authorId: 'u2',
    text: '1월은 로그 보존 기간이 지나서 없을 수도 있습니다. 확인해 볼게요.',
...

  {
    ...
    requestId: 'rq6',
    authorId: 'u3',
    text: '3개월 넘게 안 쓴 것 기준으로 지우겠습니다. 지우기 전에 목록 공유할게요.',
    createdAt: '2026-03-21T15:20',
  },

  {
    ...
    requestId: 'rq7',
    authorId: 'u3',
    text: '코드랑 뜻 표로 만들어 드리겠습니다. 자동 해지로 붙는 것도 표시할게요.',
    createdAt: '2026-03-17T10:15',
  },

  {
    ...
    requestId: 'rq8',
    authorId: 'u4',
    text: '법무 드라이브에 있습니다. 두 곳 다 필요하신가요?',
    createdAt: '2026-03-14T13:30',
  },
  {
    id: 'rc25',
    requestId: 'rq8',
    authorId: 'u1',
    text: '네 둘 다요. 그런데 저는 그 드라이브 권한이 없는 것 같습니다.',
    createdAt: '2026-03-14T14:00',
  },
  {
    id: 'rc26',
    requestId: 'rq8',
    ...
    allMeetings.value
      ...
      .map((meeting) => {
        ...
        return {
          ...
          /* 이 스토어는 곧 도메인별로 쪼개져 사라진다. 새 열 둘은 새 스토어가 채운다. */
  ...
  function meetingDetail(meetingId: string): MeetingDetail | null {
    ...
    for (const entry of entriesOfMeeting(meetingId)) {
      ...
      if (!group) {
        group = {
          thread,
          deferCount: allEntries.value.filter((e) => e.threadId === thread.id && e.kind === 'defer')
            .length,
          lines: [],
        }
        threads.push(group)
